        ...
        <div>
            {(typeof rate.rates !== 'undefined') ? (
                <div className="rates-box">
                    <div>1 {currency} - {currency === 'EUR' ? 1 : saveToFixed(rate.rates.EUR)} EUR</div>
                    <div>1 {currency} - {currency === 'USD' ? 1 : saveToFixed(rate.rates.USD)} USD</div>
                    <div>1 {currency} - {saveToFixed(rate.rates.RUB)} RUB</div>
                </div>
            ) : ('')}
        </div>
    )
