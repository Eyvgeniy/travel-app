export const cards: {
  ...
  },
  {
    ...
    capital: "Ваншингтон",
    description:
      "США, раскинувшиеся с запада на восток на 4506 километров, представляют собой огромное одеяло из пейзажей и мегаполисов. От красных каньонов Аризоны и прибрежных пляжей Калифорнии до гигантского Нью-Йорка и исторического прошлого Виргинии. Американские достопримечательности отличаются не только разнообразием и масштабностью, но и расположением в разных уголках страны.",
    img: "usa_1",
    sight_1:
